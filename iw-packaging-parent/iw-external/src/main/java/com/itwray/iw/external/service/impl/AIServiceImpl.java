...
public class AIServiceImpl implements AIService {
    ...
    @Value("${iw.ai.default.reasoning-effort:medium}")
    ...
    public String chat(String content) {
        ...
        this.applyDefaultReasoningEffort(body);
    ...
    public HttpResponse streamChat(@NonNull String chatId, @NonNull String prompt) {
        ...
        this.applyDefaultReasoningEffort(requestBody);
    ...
    private void applyDefaultReasoningEffort(AIRequestBody requestBody) {
        requestBody.setReasoning_effort(StringUtils.defaultIfBlank(
                StringUtils.trimToNull(this.defaultReasoningEffort), "medium"));
    }
